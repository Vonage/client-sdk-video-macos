...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "OpenTok",
                      url: "https://s3.amazonaws.com/artifact.tokbox.com/rel/macos-sdk/vonage-macos-sdk-2.28.0.zip",
                      checksum: "93077142c0d8eb47beebbed439624914bea847debc94f68d6383ad666b149331"),
