...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "OpenTok",
                      url: "https://s3.amazonaws.com/artifact.tokbox.com/rel/macos-sdk/vonage-macos-sdk-2.27.0.zip",
                      checksum: "d1357b63aa3ae12c0e88034d360930f7f93943d355ae910323cdad8f4dd48a7e"),
